...
class AppState:
    ...
    # Названия программ мойки: {номер программы: название}. Список программ на
    # станции общий для всех объектов, поэтому разбивки по каналам/объектам нет.
    program_name_overrides: dict[int, str] = field(default_factory=dict)
    error: str | None = None
